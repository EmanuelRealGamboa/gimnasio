    ...
    <div className="dashboard-container">
        ...
        <div className="dashboard-section">
          ...
          <div className="action-buttons">
            <button className="action-btn">Gestionar Instalaciones</button>
            <button className="action-btn">Ver Mantenimiento</button>
            <button className="action-btn">Asignar Personal</button>
          </div>
        </div>
